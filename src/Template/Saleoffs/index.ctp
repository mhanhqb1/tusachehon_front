                        ...
                        <div class="product-active-2 owl-carousel">
                            <?php
                                ...
                                <div class="product-total-2">
                                    <?php echo $this->element('Layout/home/product_item_3', array('product' => $newProducts[$i])); ?>
                                    <?php echo $this->element('Layout/home/product_item_3', array('product' => $newProducts[$count + $i])); ?>
                                </div>
                                <?php endfor; ?>
                        </div>
                    </div>
