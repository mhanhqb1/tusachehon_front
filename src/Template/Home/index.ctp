            ...
            <div class="col-lg-12">
                ...
                <div class="tab-menu mb-40 text-center">
                    <ul class="nav justify-content-center">
                        <li><a class="active" href="#Audiobooks" data-toggle="tab">Sản phẩm mới </a></li>
                        <li><a href="#books" data-toggle="tab">Khuyến mãi</a></li>
            ...
            <div class="tab-pane fade show active" id="Audiobooks">
                <div class="tab-active owl-carousel">
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="#">
                                <img src="<?php echo $BASE_URL;?>/images/product/3.jpg" alt="book" class="primary" />
                            </a>
                            <div class="quick-view">
                                <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                    <i class="fa fa-search-plus"></i>
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="#">
                                <img src="<?php echo $BASE_URL;?>/images/product/5.jpg" alt="book" class="primary" />
                            </a>
                            <div class="quick-view">
                                <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                    <i class="fa fa-search-plus"></i>
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="#">
                                <img src="<?php echo $BASE_URL;?>/images/product/7.jpg" alt="book" class="primary" />
                            </a>
                            <div class="quick-view">
                                <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                    <i class="fa fa-search-plus"></i>
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="#">
                                <img src="<?php echo $BASE_URL;?>/images/product/9.jpg" alt="book" class="primary" />
                            </a>
                            <div class="quick-view">
                                <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                    <i class="fa fa-search-plus"></i>
                    ...
                    <div class="product-wrapper">
                        <div class="product-img">
                            <a href="#">
                                <img src="<?php echo $BASE_URL;?>/images/product/11.jpg" alt="book" class="primary" />
                            </a>
                            <div class="quick-view">
                                <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                    <i class="fa fa-search-plus"></i>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12 col-12">
                ...
                <div class="banner-img-2">
                    <a href="#"><img src="<?php echo $BASE_URL;?>/images/banner/6.jpg" alt="banner" /></a>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 col-12">
                <div class="bestseller-active owl-carousel">
                    <div class="bestseller-total">
                        <div class="single-bestseller mb-25">
                            <div class="bestseller-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/13.jpg" alt="book" /></a>
                                <div class="product-flag">
                                    <ul>
                                        <li><span class="sale">new</span></li>
                                        <li><span class="discount-percentage">-5%</span></li>
                        ...
                        <div class="single-bestseller">
                            <div class="bestseller-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/14.jpg" alt="book" /></a>
                                <div class="product-flag">
                                    <ul>
                                        <li><span class="sale">new</span></li>
                                    </ul>
                    ...
                    <div class="bestseller-total">
                        <div class="single-bestseller mb-25">
                            <div class="bestseller-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/15.jpg" alt="book" /></a>
                                <div class="product-flag">
                                    <ul>
                                        <li><span class="sale">new</span></li>
                                    </ul>
                        ...
                        <div class="single-bestseller">
                            <div class="bestseller-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/16.jpg" alt="book" /></a>
                                <div class="product-flag">
                                    <ul>
                                        <li><span class="sale">new</span></li>
                                        <li><span class="discount-percentage">-5%</span></li>
                    ...
                    <div class="bestseller-total">
                        <div class="single-bestseller mb-25">
                            <div class="bestseller-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/17.jpg" alt="book" /></a>
                                <div class="product-flag">
                                    <ul>
                                        <li><span class="sale">new</span></li>
                                    </ul>
        ...
        <div class="tab-active owl-carousel">
            <div class="tab-total">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="#">
                            <img src="<?php echo $BASE_URL;?>/images/product/18.jpg" alt="book" class="primary" />
                        </a>
                        <div class="quick-view">
                            <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                <i class="fa fa-search-plus"></i>
            ...
            <div class="tab-total">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="#">
                            <img src="<?php echo $BASE_URL;?>/images/product/10.jpg" alt="book" class="primary" />
                        </a>
                        <div class="quick-view">
                            <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                <i class="fa fa-search-plus"></i>
            ...
            <div class="tab-total">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="#">
                            <img src="<?php echo $BASE_URL;?>/images/product/19.jpg" alt="book" class="primary" />
                        </a>
                        <div class="quick-view">
                            <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                <i class="fa fa-search-plus"></i>
            ...
            <div class="tab-total">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="#">
                            <img src="<?php echo $BASE_URL;?>/images/product/4.jpg" alt="book" class="primary" />
                        </a>
                        <div class="quick-view">
                            <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                <i class="fa fa-search-plus"></i>
            ...
            <div class="tab-total">
                ...
                <div class="product-wrapper">
                    <div class="product-img">
                        <a href="#">
                            <img src="<?php echo $BASE_URL;?>/images/product/8.jpg" alt="book" class="primary" />
                        </a>
                        <div class="quick-view">
                            <a class="action-view" href="#" data-target="#productModal" data-toggle="modal" title="Quick View">
                                <i class="fa fa-search-plus"></i>
            ...
            <div class="col-lg-3 col-md-4 col-12">
                ...
                <div class="product-active-2 owl-carousel">
                    <div class="product-total-2">
                        <div class="single-most-product bd mb-18">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/20.jpg" alt="book" /></a>
                            </div>
                        ...
                        <div class="single-most-product bd mb-18">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/21.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
                        ...
                        <div class="single-most-product">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/22.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
                    ...
                    <div class="product-total-2">
                        <div class="single-most-product bd mb-18">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/23.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
                        ...
                        <div class="single-most-product bd mb-18">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/24.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
            ...
            <div class="col-lg-3 col-md-4 col-12">
                ...
                <div class="product-active-2 owl-carousel">
                    <div class="product-total-2">
                        ...
                        <div class="single-most-product">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/26.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
            ...
            <div class="col-lg-3 col-md-4 col-12">
                ...
                <div class="product-active-2 owl-carousel">
                    <div class="product-total-2">
                        <div class="single-most-product bd mb-18">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/27.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
                        ...
                        <div class="single-most-product bd mb-18">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/28.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
                        ...
                        <div class="single-most-product">
                            <div class="most-product-img">
                                <a href="#"><img src="<?php echo $BASE_URL;?>/images/product/29.jpg" alt="book" /></a>
                            </div>
                            <div class="most-product-content">
                                <div class="product-rating">
                                    <ul>
